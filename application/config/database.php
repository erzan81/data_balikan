...
$tnsname = '(DESCRIPTION =(ADDRESS = (PROTOCOL = TCP)(HOST = 10.14.160.217)(PORT = 1521))(CONNECT_DATA =(SID = KONOHA)))';
//$tnsname = '(DESCRIPTION =(ADDRESS = (PROTOCOL = TCP)(HOST =36.78.6.53)(PORT = 1521))(CONNECT_DATA =(SID = KONOHA)))';
//$tnsname = '(DESCRIPTION =(ADDRESS = (PROTOCOL = TCP)(HOST =192.168.3.34)(PORT = 1521))(CONNECT_DATA =(SID = KONOHA)))';
...
$db['pblmig']['hostname'] = 'localhost';
$db['pblmig']['username'] = 'root';
$db['pblmig']['password'] = '';
$db['pblmig']['database'] = 'tbl_cocur';
